...
export default function LoginForm(){
    ...
    return (
        <div className="w-full max-w-md mx-auto">
                <div className="bg-gradient-to-br from-[#181b20cc] to-[#1d2025e6]  backdrop-blur-lg
                 border-[#2c313a]/50 shadow-[#181b1f] rounded-lg">
                    ...
                    <div className="pt-0 p-6 space-y-6">
                        <form onSubmit={handleLogin} className="space-y-4">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <Link 
                                    ...
                                    className="text-sm text-[#5593f7]
                                    hover:text-[#5593f7]/80 transition-colors"
                                >
                                    Esqueceu sua senha?
                                </Link>
                            </div>
                            <button
                                ...
                                from-[#5593f7] to-[#1d4fd7] w-full h-[50px]
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <button className="border border-[#2c313a]/50 rounded-xl
                             bg-[#111418] h-[45px] text-[#F1F2F3] flex items-center
                              justify-center gap-4 hover:bg-[#F15000] transition-all duration-300 ease-in-out cursor-pointer">
                                <FiGithub size={20} />
                                <span className="text-sm font-medium">Github</span>
                            </button>
                            <button className="border border-[#2c313a]/50 rounded-xl
                             bg-[#111418] h-[45px] text-[#F1F2F3] flex items-center
                              justify-center gap-4 hover:bg-[#4181EE] transition-all duration-300 ease-in-out cursor-pointer">
                        ...
                        <div className="text-center text-sm text-gray-500">
                            Não tem uma conta?{" "}
                            <Link href="/register" className="text-[#5593f7] hover:text-[#5593f7]/80 transition-colors font-medium">
                                Cadastre-se
                            </Link>
                        </div>
                    </div>
